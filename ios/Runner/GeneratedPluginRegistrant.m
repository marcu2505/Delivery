...
#if __has_include(<stripe_native/StripeNativePlugin.h>)
#import <stripe_native/StripeNativePlugin.h>
#else
@import stripe_native;
#endif
...
+ (void)registerWithRegistry:(NSObject<FlutterPluginRegistry>*)registry {
  ...
  [StripeNativePlugin registerWithRegistrar:[registry registrarForPlugin:@"StripeNativePlugin"]];
