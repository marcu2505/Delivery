...
class CategoryFilterPage extends StatefulWidget {
  ...
  CategoryFilterPage({@required this.category});

  @override
  _CategoryFilterPageState createState() =>
      _CategoryFilterPageState(category: this.category);
}

class _CategoryFilterPageState extends State<CategoryFilterPage> {
  final Category category;
  _CategoryFilterPageState({@required this.category});
      ...
      content: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            ...
            CategoryFilterTitle(category: this.category),
...
class CategoryFilterTitle extends StatelessWidget {
  final Category category;
  const CategoryFilterTitle({@required this.category});
      ...
      child: Row(
        ...
        children: <Widget>[
          Container(
            ...
            child: Text(
              "CATEGORIA: ${this.category.name.toUpperCase()}",
              style: TextStyle(
                  fontSize: 20,
                  color: Colors.black,
...
class CategoryFilterTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        // Get.to(RestaurantPage(id: this.id)); TODO
      },
      child: Column(
        children: <Widget>[
          Container(
...
class CategoryFilterList extends StatelessWidget {
  ...
  Stream<List<Restaurant>> getCategoryRestaurant(Category category) async* {
